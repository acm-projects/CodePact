...
const CongratsView = ({ navigate }) => (
  <div
    className={`${FEATURE_BG} ${BORDER_COLOR} border rounded-2xl p-6 sm:p-10 shadow-2xl shadow-fuchsia-900/50 text-center animate-fade-in`}
  >
    ...
    <p className="text-gray-400 text-base mb-8 font-light max-w-md mx-auto font-quicksand">
      You've successfully secured your place in the CodePact collective. You can
      now proceed to log in and start collaborating.
    </p>
...
export default function Congratulations() {
  ...
  return (
    <div
      className={`min-h-screen ${BACKGROUND_COLOR} text-white relative overflow-hidden flex flex-col font-quicksand`}
    >
      <GridOverlay />
