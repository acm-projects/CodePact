        ...
        <div className="text-center mb-12">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              team-oriented experience. Form squads with friends, share resources, 
              and provide feedback to stay motivated and succeed together.
            </p>
          </div>
            ...
            {[
              {
                icon: "👥",
                title: "Form Squads",
                description: "Team up with friends to create your job-hunting squad. Tackle challenges, share wins, and stay accountable throughout the process."
              },
              {
                icon: "📚",
                title: "Shared Resources",
                description: "Access a curated library of coding problems, interview guides, and resume templates. Build your collective knowledge base."
              },
              {
                icon: "🏆",
                title: "Live Feeds & Leaderboards",
                description: "Stay motivated with real-time squad updates and application leaderboards. Celebrate every win together."
              }
            ].map((feature, index) => (
              <div 
                key={index}
